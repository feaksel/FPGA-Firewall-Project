...
def main():
    ...
    parser.add_argument("--sine-hz", type=int, default=440)
    parser.add_argument("--samples-per-packet", type=int, default=64)
    parser.add_argument("--packets-per-second", type=float, default=80.0)
