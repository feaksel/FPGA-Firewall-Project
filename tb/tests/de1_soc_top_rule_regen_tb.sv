...
module de1_soc_top_rule_regen_tb;
    import fw_tb_pkg::*;
    ...
    initial begin
        ...
        expect_bit("top_rule_regen.init_done", ledr[0], 1'b1);
        expect_bit("top_rule_regen.init_error", ledr[1], 1'b0);
        expect_bit("top_rule_regen.saw_recv_a", saw_recv_cmd_a, 1'b1);
        expect_bit("top_rule_regen.saw_send_b", saw_send_cmd_b, 1'b1);
        expect_u16("top_rule_regen.tx_frame_len", tx_frame_len_b, 16'd78);
        u_b_model.expect_sent_byte(0, 8'hff);
        u_b_model.expect_sent_byte(6, 8'h00);
        u_b_model.expect_sent_byte(52, "F");

        $display("PASS: de1_soc_top_rule_regen_tb");
        $finish;
    end
endmodule
